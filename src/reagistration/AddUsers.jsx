        ...
        <div className="addUserContainer">
            ...
            <div className="add-user-part">
                ...
                <div className="add-user-entrece-form">
                    {/*User form part*/}
                    <form action="" className="add-user-complate-form">
                        {/*Firstname's place*/}
                        <div className="add-user-notes-part firstname-part">
                            ...
                            <input type="text" id="firstname" className="add-user-notes-input add-firstname-input" placeholder="Enter your firstname ..."/>
                        </div>
                        ...
                        <div className="add-user-notes-part lastname-part">
                            ...
                            <input type="text" id="lastname" className="add-user-notes-input add-lastname-input" placeholder="Enter your lastname ..."/>
                        </div>
                        ...
                        <div className="add-user-dates-note-place">
                            ...
                            <div className="add-user-data-notes">
                                ...
                                <div className="add-user-date-day-select">
                                    <select name="" id="" className="add-user-date-day-slect">
                                ...
                                <div className="add-user-date-month-selection">
                                    <select name="" id="" className="add-user-date-month-selection">
                                ...
                                <div className="add-user-date-year-input">
                                    <input type="text" className="add-user-input-place" placeholder="year"/>
                                </div>
                            </div>
                        </div>
                        ...
                        <div className="add-user-address-part">
                            ...
                            <input type="text" className="add-user-address-input-place"/>
                        </div>
